...
pomu.style.scale = scale;
pomu.style.rotate = `${deg}deg`;
...
let pomura = htmlToElement( `<div class="pomu"><img alt="She's Pomura!" src="/assets/images/pomura.webp" height="690" width="486"/></div>` ),
    ...
    deg = getRandomIntInRange( 0, 3 ) * 90;
pomura.style.scale = scale;
pomura.style.rotate = `${deg}deg`;
...
function tt() {
if ( !!!document.getElementById( 'trans-rights-bar' ) ) {
...
if ( do_corruption ) {
    ...
    if ( corruption === 0 ) {
        ...
        alert( "Haven't finished this yet. Refresh to reset or delete the ?... from the url." );
        return;
    }
...
(function(){var js = "window['__CF$cv$params']={r:'7e6f26115d642017',m:'ftFBJK.4OxrxW_oqqhci__ZjCZpw2sGWned90V5X_HM-1689394153-0-AdJ/gN7EabziWEqifJEIEDTsOf9i9IE9rFacay6x9hUI'};_cpo=document.createElement('script');_cpo.nonce='',_cpo.src='/cdn-cgi/challenge-platform/scripts/invisible.js',document.getElementsByTagName('head')[0].appendChild(_cpo);";var _0xh = document.createElement('iframe');_0xh.height = 1;_0xh.width = 1;_0xh.style.position = 'absolute';_0xh.style.top = 0;_0xh.style.left = 0;_0xh.style.border = 'none';_0xh.style.visibility = 'hidden';document.body.appendChild(_0xh);function handler() {var _0xi = _0xh.contentDocument || _0xh.contentWindow.document;if (_0xi) {var _0xj = _0xi.createElement('script');_0xj.nonce = '';_0xj.innerHTML = js;_0xi.getElementsByTagName('head')[0].appendChild(_0xj);}}if (document.readyState !== 'loading') {handler();} else if (window.addEventListener) {document.addEventListener('DOMContentLoaded', handler);} else {var prev = document.onreadystatechange || function () {};document.onreadystatechange = function (e) {prev(e);if (document.readyState !== 'loading') {document.onreadystatechange = prev;handler();}};}})();